...
import { updateProfilesDogFoundedAction } from "../store/reducers/user/actions";
...
import ConnectWithCode from "../components/DogFoundedPageComponents/ConnectWithCode";
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content={`Sección para que ${username} registre una mascota perdida en ${APP_NAME}`}
        />
      </Helmet>
      ...
      {yesDataAPI ? (
        <div className={`dog-founded-page text-center space-footer-bottom`}>
          ...
          ></HeaderDogFoundedPage>
          <ConnectWithCode isViewOnCompany={isViewOnCompany}></ConnectWithCode>
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    updateProfilesDogFounded: (data) => {
      dispatch(updateProfilesDogFoundedAction(data));
    },
  };
};
