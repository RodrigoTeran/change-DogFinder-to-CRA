...
// Acciones
import { updateProfilesAction } from "../store/reducers/user/actions";
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content={`Perfil ${APP_NAME} de ${username}`}
        />
      </Helmet>
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    updateProfiles: (data) => {
      dispatch(updateProfilesAction(data));
    },
