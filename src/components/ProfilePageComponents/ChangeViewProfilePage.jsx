    ...
    <>
      {!userCompany ? (
        <></>
          ...
          <>
            <div className="change-view-company-and-user">
            ...
            <div className="change-view-company-and-user-line"></div>
          </>
        )}
    </>
  )
...
export default connect(mapStateToProps)(ChangeViewProfilePage);