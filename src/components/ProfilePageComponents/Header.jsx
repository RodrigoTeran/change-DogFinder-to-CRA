...
const HeaderProfilePage = ({
  ...
  const goToPurchase = () => {
    Router.push("/comprar"); // Lo manda al purchase
  };
  return (
    <div className="d-flex row justify-content-around align-items-center">
      ...
      <div className="col-lg-6 col-md-6 col-sm-10 text-center my-3">
        <ButtonWhiteRectangle text="Adquirir un perfil" width="190px" height="50px" fontSize="1rem" clickFunction={goToPurchase} mt="mt-0">
