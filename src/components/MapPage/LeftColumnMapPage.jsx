...
const MatchComponent = ({
    ...
    if (!auth) {
      ...
      if (
        ...
        updateFailureMessagesComponent({
          state: true,
          title: "Error",
          description: "No puedes contactar a este usuario/empresa ya que no cuentas con tu propia información de contacto... En la página de tu perfil podrás llenar los requerimientos (mail y teléfono). Esto lo hacemos para asegurar que ellos también te puedan contactar."
        });
      } else {
  ...
  return (
    <div className="match-container">
      ...
      <div className="match-button" onClick={checkIfItCanDoMatch}>
