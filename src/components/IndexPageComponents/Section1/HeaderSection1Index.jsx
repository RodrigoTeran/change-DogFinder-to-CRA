  ...
  return (
    <div className="container">
      ...
      <div className="row justify-content-center">
        ...
        <CardSection1Index
          id="card-index-section-1-4"
          title="Ayudamos al medio ambiente"
          description="Prevenimos usar posters, contaminan las calles. Mejor usamos la tecnología, más rápida y eficiente."
        >
          <svg
            className="icon-card-section-1-index"
            xmlns="http://www.w3.org/2000/svg"
        ...
        <CardSection1Index
          id="card-index-section-1-6"
          title="En contacto con notificaciones seguras"
          description={
            "Tenemos un sistema de privacidad excelente. Cuando alguien ve tu información de contacto, se te notificará al instante."
          }
        >
          <svg
            className="icon-card-section-1-index"
