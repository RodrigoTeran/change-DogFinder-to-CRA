  ...
  return (
    <div className="pet-profile-page-header">
      <div className="pet-profile-page-header-h1">
        {petProfile.name}
        <div title="Cambiar nombre de mascota">
      ...
      <img className="pet-profile-page-header-profile-image" src={`/Images/${petProfile.petProfileImage}.${getWebp ? ("webp") : ("png")}`} alt="Perfil" />
    </div>
  )
};
