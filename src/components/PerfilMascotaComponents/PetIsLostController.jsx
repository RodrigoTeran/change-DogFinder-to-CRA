...
const PetIsLostController = ({
      ...
      .then((data) => {
        ...
        if (data.status === "false") {
          ...
          updateFailureMessagesComponent({
            ...
            title: "Error",
            description:
              "No puedes cambiar su estado hasta que elimines la notificación correspondiente. Esto lo hacemos para asegurar que veas la notificación.",
          });
  ...
  return (
    <div className="control-pet-profile-petislost-daddy">
      ...
      <div
        className={`control-pet-profile-petislost-label ${
      ...
      >
        <div>
          ...
          <div
            className={`control-pet-profile-petislost-label-text ${
              yesInstructions ? "open" : "close"
            }`}
          >
            Es importante para nosotros saber si necesitas que busquemos a tu
            mascota. Actualiza su estado para avisarle a nuestra Inteligencia
            Artificial si la intenta buscar o no. Su mascota solo va a salir en
            el mapa si está registrada como perdida.
          </div>
        </div>
      </div>
    </div>
