...
import { editPetProfileImage } from "../../routes/index";

import { getPetProfile } from "../../store/reducers/user/selector";

import { editProfileDogFoundedImagePet } from "../../routes/indexDogFounded";
      ...
      .put(
        `${
          petProfile.isPetProfile
            ? `${editPetProfileImage}/${getURL()}`
            : `${editProfileDogFoundedImagePet}/${getURL()}`
        }`,
        data,
        {
          headers: {
