      ...
      .then((data) => {
        ...
        if (data.msg === "msg") {
          ...
          updateFailureMessagesComponent({
            state: true,
            title: "Error",
            description: `No se puede borrar el perfil ya que tienes una notificación relacionada con este perfil. Cuando elimines la notificación podrás borrar este perfil.`,
          });
        } else {
          updateFailureMessagesComponent({
            state: true,
